...
用法:
  python tools/fetch_biomed_paper.py                      # 默认抓演示用的那篇（PMC13331974）
  python tools/fetch_biomed_paper.py --query 'TITLE:"meta-analysis" AND OPEN_ACCESS:Y'
  python tools/fetch_biomed_paper.py --pmcid PMC13331974  # 直接指定
"""
