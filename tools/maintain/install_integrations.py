...
用法:
  python tools/maintain/install_integrations.py            # 装到本仓库（项目级）
  python tools/maintain/install_integrations.py --user     # 同时装到用户级目录
  python tools/maintain/install_integrations.py --check    # 只检查现状，不写文件
"""
...
def main(argv=None) -> int:
    ...
    print("验证：python tools/maintain/install_integrations.py --check")
    return 0
